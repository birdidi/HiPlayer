    ...
    private void initView() {
        findViewById(R.id.btn_process_video).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                jumpToMediaEdit.setClass(VideoActivity.this, VideoEditActivity.class);
        ...
        findViewById(R.id.btn_guide).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                jumpGuide.setClass(VideoActivity.this, GuideActivity.class);
                VideoActivity.this.startActivity(jumpGuide);
            }
        });
    }
