...
//		Log.e("getMetrics", "getMetrics");
     ...
     * @return
     */
    public static boolean isExLardgeScreenAndLowDensity(Context ctx) {
        //是大屏，且屏幕密度小于指的基准密度
        if (isExLardgeScreen(ctx) && getDensity(ctx) < LARGE_SCREEN_DENSITY) {
            return true;
        }
        return false;
    }
     ...
     * @return
     */
    public static boolean isSuperLargeScreenAndLowDensity(Context ctx) {
        //是超大屏，且屏幕密度小于指的基准密度
        if (isSuperLargeScreen(ctx) && getDensity(ctx) < SUPER_LARGE_SCREEN_DENSITY) {
            return true;
        }
        return false;
    }
     ...
     * @return
     */
    public static boolean isLargeScreenAndSuperLowDensity(Context ctx) {
        if (isMLargeScreen(ctx) && getDensity(ctx) <= LARGE_SCREEN_SUPER_LOW_DENSITY) {
            return true;
        }
        return false;
    }
     ...
     * @return boolean
     */
    public static boolean isLowScreen(Context ctx) {
    ...
    public static boolean isBigScreenLowDip(Context ctx) {
        if (ctx == null) {
            return false;
        }
        final WindowManager windowManager = (WindowManager) ctx.getSystemService(Context.WINDOW_SERVICE);
